...
export const CreateDirectionModal = () => {
   ...
   function addIncTerm(term: string) {
      if (term && term.trim()) setInclusionTerms(inclusionTerms.add(term));
   }
   function addExcTerm(term: string) {
      if (term && term.trim()) setExclusionTerms(exclusionterms.add(term));
   }
                     ...
                     >
                        ...
                        <FormRow label="Termos adicionados" name="new_terms">
                           <div className={styles.termsList}>
                              {Array.from(inclusionTerms.values()).map(
                                 (term) => {
                                    return (
                        ...
                        <FormRow label="Termos adicionados" name="bad_terms">
                           <div className={styles.termsList}>
                              {Array.from(exclusionterms.values()).map(
                                 (term) => {
                                    return (
                                       <div className={styles.term}>
                                          <Typography
